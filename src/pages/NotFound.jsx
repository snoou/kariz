        ...
        <div className="min-h-[80vh] flex items-center justify-center p-4">
            <div className="comic-panel p-8 md:p-12 max-w-4xl w-full bg-white relative transform rotate-1 transition-transform duration-300 hover:rotate-0 mt-8">
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                    ...
                    <button
                        onClick={() => navigate('/')}
                        className="text-2xl md:text-3xl font-comic bg-yellow-400 border-4 border-black px-8 py-5 shadow-[6px_6px_0_0_#000] hover:bg-yellow-300 active:translate-y-2 active:translate-x-2 active:shadow-none transition-all flex flex-col md:flex-row items-center gap-2 md:gap-4"
                    >
